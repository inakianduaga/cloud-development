...
#
$ACTION cloud_frontend_proxy CERTIFICATES_PATH=$FRONTEND_PROXY_CERTIFICATES_PATH CONFIG_PATH=$CONFIG_PATH USERS_CONFIG_PATH=$USERS_PATH PROXY_HOST=$DOCKER_INTERFACE
